...
namespace payzen_backend.Controllers.Company
{
    ...
    public class CompanyDocumentsController : ControllerBase
    {
        ...
        /// <summary>
        /// Récupère tous les documents (non supprimés)
        /// </summary>
        [HttpGet]
        ...
        /// <summary>
        /// Upload et crée un nouveau document
        /// </summary>
        [HttpPost("upload")]
        ...
        public async Task<ActionResult<CompanyDocumentReadDto>> Upload([FromForm] CompanyDocumentUploadDto dto)
        {
            ...
            try
            {
                ...
                _logger.LogInformation("Document créé avec succès : {DocumentId} pour l'entreprise {CompanyId}", 
        ...
        /// <summary>
        /// Crée un nouveau document (sans upload de fichier)
        /// </summary>
        [HttpPost]
        ...
        public async Task<ActionResult<CompanyDocumentReadDto>> Update(int id, [FromBody] CompanyDocumentUpdateDto dto)
        {
            ...
            _logger.LogInformation("Document mis à jour : {DocumentId}", id);
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            _logger.LogInformation("Document supprimé : {DocumentId}", id);
