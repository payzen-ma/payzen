...
// NOTE: This Program.cs is the refactored copy (inside payzen_backend_refactored/).
// Phase 1 changes: register infrastructure services (rate limiting, options)
// and prepare validators placeholder. See Extensions/ServiceCollectionExtensions.cs.
...
// Register custom rate limiting and bind options using the Options pattern.
...
builder.Services.AddScoped<payzen_backend.Services.Company.Interfaces.ICompanyService, payzen_backend.Services.Company.CompanyService>();
...
// Middlewares (Phase 1)
// UseApplicationMiddlewares registers RequestLoggingMiddleware, ExceptionHandlerMiddleware
// and the rate limiter. These middlewares were added as part of Phase 1.
