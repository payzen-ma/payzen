namespace payzen_backend.DTOs.Payroll
{
    ...
    public class JournalPaieRow
    {
        ...
        public int NbrJrsTravailles { get; set; }
        public decimal JrsFeries { get; set; }
        public decimal SBPlusConge { get; set; }
        public decimal SalaireBaseDuMois { get; set; }
        public int NbrDeductions { get; set; }
        public decimal CNSSPartSalariale { get; set; }
        public decimal AMOPartSalariale { get; set; }
        public decimal FraisProfesADeduireM { get; set; }
        public decimal IRAPayer { get; set; }
        public decimal SalaireNet { get; set; }
        public decimal InteretLogement { get; set; }
        ...
        public decimal NbrJrsConge { get; set; }
        public decimal MTAnciennete { get; set; }
        public decimal LesPrimesImposables { get; set; }
        public decimal BrutImposable { get; set; }
        public decimal MutuellePartSalariale { get; set; }
        public decimal CIMR { get; set; }
        public decimal NetImposable { get; set; }
        public decimal MtExonere { get; set; }
        public decimal BrutGlobal { get; set; }
        public decimal Avance { get; set; }
        public decimal HeuresSup25 { get; set; }
        public decimal HeuresSup100 { get; set; }
    }
    ...
    public class EtatCnssFullRow
    {
        ...
        public decimal RgSalarial { get; set; }
        ...
        public decimal ParticipationAmo { get; set; }
    ...
    public class EtatIrFullRow
    {
        ...
        public string NomPrenom { get; set; } = string.Empty;
        public decimal SalImposable { get; set; }
        public decimal MontantIGR { get; set; }
    }
