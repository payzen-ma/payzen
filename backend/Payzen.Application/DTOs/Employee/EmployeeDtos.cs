...
public class EmployeeCreateDto
{
    ...
    public required string CinNumber
    {
        get; set;
    }
...
public class EmployeeUpdateDto
{
    ...
    public decimal? CimrEmployeeRate
    {
        get; set;
    }
    public decimal? CimrCompanyRate
    {
        get; set;
    }
    ...
    public string? PrivateInsuranceNumber
    {
        get; set;
    }
    public decimal? PrivateInsuranceRate
    {
        get; set;
    }
...
public class EmployeeReadDto
{
    ...
    public string? CimrEmployeeRate
    {
        get; set;
    }
    public string? CimrCompanyRate
    {
        get; set;
    }
...
public class EmployeeDetailHistoryEventDto
{
    ...
    public EmployeeHistoryEventDetailsDto? Details
    {
        get; set;
    }
...
public class CountryDto
{
    ...
    public string CountryName { get; set; } = string.Empty; public string? CountryPhoneCode
    {
        get; set;
    }
}
public class CityDto
{
    ...
    public string CityName { get; set; } = string.Empty; public int CountryId
    {
        get; set;
    }
...
public class DepartementDto
{
    ...
    public string DepartementName { get; set; } = string.Empty; public int CompanyId
    {
        get; set;
    }
}
public class JobPositionDto
{
    ...
    public string Name { get; set; } = string.Empty; public int CompanyId
    {
        get; set;
    }
}
public class ContractTypeDto
{
    ...
    public string ContractTypeName { get; set; } = string.Empty; public int CompanyId
    {
        get; set;
    }
}
public class EmployeeDto
{
    ...
    public string FirstName { get; set; } = string.Empty; public string LastName { get; set; } = string.Empty; public string FullName { get; set; } = string.Empty; public string? DepartementName
    {
        get; set;
    }
}
...
public class EmployeeContractCreateDto
{
    ...
    public required int JobPositionId
    {
        get; set;
    }
    ...
    public required int ContractTypeId
    {
        get; set;
    }
...
public class EmployeeSalaryComponentCreateDto
{
    ...
    public required int EmployeeSalaryId
    {
        get; set;
    }
    ...
    public required string ComponentType
    {
        get; set;
    }
...
public class EmployeeAbsenceCreateDto
{
    ...
    public DateOnly AbsenceDate
    {
        get; set;
    }

    [Required(ErrorMessage = "Le type de durée est requis")]
    public AbsenceDurationType DurationType
    {
        get; set;
    }
    ...
    public required string AbsenceType
    {
        get; set;
    }
...
public class EmployeeAbsenceReadDto
{
    ...
    public string? HalfDayDescription
    {
        get; set;
    }
    public TimeOnly? StartTime
...
public class EmployeeAbsenceStatsDto
{
    ...
    public int FullDayAbsences
    {
        get; set;
    }
    public int HalfDayAbsences
    {
        get; set;
    }
    public int HourlyAbsences
    {
        get; set;
    }
...
public class EmployeeOvertimeCreateDto
{
    ...
    public required DateOnly OvertimeDate
    {
        get; set;
    }
...
public class EmployeeOvertimeReadDto
{
    ...
    public decimal RateMultiplierApplied
    {
        get; set;
    }
    ...
    public DateTime? ProcessedInPayrollAt
    {
        get; set;
    }
...
public class EmployeeAttendanceReadDto
{
    ...
    public int BreakMinutesApplied
    {
        get; set;
    }
...
public class EmployeeCategoryCreateDto
{
    ...
    public string? PayrollPeriodicity
    {
        get; set;
    }
}
...
public class SageImportRowDto
{
    ...
    public string? EmploiOccupe
    {
        get; set;
    }
    public string? TauxAnc
    {
        get; set;
    }
    public string? Anct
...
public class SageImportCreatedItemDto
{
    ...
    public string FullName { get; set; } = string.Empty; public int? Matricule
    {
        get; set;
    }
    public string Email { get; set; } = string.Empty;
