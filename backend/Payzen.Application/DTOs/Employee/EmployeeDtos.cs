...
public class CountryDto { public int Id { get; set; } public string CountryName { get; set; } = string.Empty; public string? CountryPhoneCode { get; set; } }
public class CityDto { public int Id { get; set; } public string CityName { get; set; } = string.Empty; public int CountryId { get; set; } public string? CountryName { get; set; } }
public class DepartementDto { public int Id { get; set; } public string DepartementName { get; set; } = string.Empty; public int CompanyId { get; set; } }
public class JobPositionDto { public int Id { get; set; } public string Name { get; set; } = string.Empty; public int CompanyId { get; set; } }
public class ContractTypeDto { public int Id { get; set; } public string ContractTypeName { get; set; } = string.Empty; public int CompanyId { get; set; } }
public class EmployeeDto { public int Id { get; set; } public string FirstName { get; set; } = string.Empty; public string LastName { get; set; } = string.Empty; public string FullName { get; set; } = string.Empty; public string? DepartementName { get; set; } }
public class NationalityDto { public int Id { get; set; } public string Name { get; set; } = string.Empty; }
public class StatusFormDto { public int Id { get; set; } public string Name { get; set; } = string.Empty; }
public class GenderFormDto { public int Id { get; set; } public string Name { get; set; } = string.Empty; }
public class EducationLevelFormDto { public int Id { get; set; } public string Name { get; set; } = string.Empty; }
public class MaritalStatusFormDto { public int Id { get; set; } public string Name { get; set; } = string.Empty; }
...
public static class OvertimeTypeHelper
{
    ...
    {
        if (type == OvertimeType.None) return "Aucun";
        var parts = new List<string>();
        if ((type & OvertimeType.PublicHoliday) != 0) parts.Add("Jour férié");
        else if ((type & OvertimeType.WeeklyRest) != 0) parts.Add("Repos hebdomadaire");
        else if ((type & OvertimeType.Standard) != 0) parts.Add("Standard");
        if ((type & OvertimeType.Night) != 0) parts.Add("Nuit");
        return parts.Count > 0 ? string.Join(" + ", parts) : type.ToString();
    }

    public static string GetDescriptionEn(OvertimeType type)
    {
        if (type == OvertimeType.None) return "None";
        var parts = new List<string>();
        if ((type & OvertimeType.PublicHoliday) != 0) parts.Add("Public Holiday");
        else if ((type & OvertimeType.WeeklyRest) != 0) parts.Add("Weekly Rest");
        else if ((type & OvertimeType.Standard) != 0) parts.Add("Standard");
        if ((type & OvertimeType.Night) != 0) parts.Add("Night");
        return parts.Count > 0 ? string.Join(" + ", parts) : type.ToString();
    }
}
...
public class SageImportCreatedItemDto { public int Id { get; set; } public string FullName { get; set; } = string.Empty; public int? Matricule { get; set; } public string Email { get; set; } = string.Empty; }
public class SageImportUpdatedItemDto { public int Id { get; set; } public string FullName { get; set; } = string.Empty; public int? Matricule { get; set; } public string Email { get; set; } = string.Empty; }
public class SageImportErrorDto { public int Row { get; set; } public string? FullName { get; set; } public string Message { get; set; } = string.Empty; }
