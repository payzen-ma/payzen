...
public class InvitationAcceptResult
{
    ...
    public static InvitationAcceptResult Success() 
        => new() { IsSuccess = true };
    
    public static InvitationAcceptResult NotFound() 
        => new() { IsSuccess = false, Error = "INVITATION_NOT_FOUND" };
    
    public static InvitationAcceptResult AlreadyUsed() 
        => new() { IsSuccess = false, Error = "INVITATION_ALREADY_USED" };
    
    public static InvitationAcceptResult Expired() 
        => new() { IsSuccess = false, Error = "INVITATION_EXPIRED" };
