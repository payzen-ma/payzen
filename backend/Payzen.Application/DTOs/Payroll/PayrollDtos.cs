...
public class EmployeePayrollDto
{
    ...
    public string? LegalContractType
    {
        get; set;
    }
    public string? StateEmploymentProgram
    {
        get; set;
    }
...
public class PayrollResultReadDto
{
    ...
    // Net
    public decimal? SalaireNetAvantArrondi
    {
        get; set;
    }
    ...
    public List<PayrollAuditStepDto>? AuditSteps
    {
        get; set;
    }
...
public class PayrollSummaryDto
{
    ...
    // Base IR
    public decimal GrossTaxable
    {
        get; set;
    }
    public decimal ProfessionalExpenses
    {
        get; set;
    }
    ...
    // IR
    public decimal IncomeTaxGross
    {
        get; set;
    }
    public decimal FamilyDeductions
    {
        get; set;
    }
    public decimal IncomeTaxNet
    {
        get; set;
    }
    ...
    // Charges patronales
    public decimal CnssEmployer
    {
        get; set;
    }
    public decimal AllocationsFamiliales
    {
        get; set;
    }
    public decimal TaxeProfessionnelle
    {
        get; set;
    }
    public decimal AmoEmployer
    {
        get; set;
    }
    public decimal CimrEmployer
    {
        get; set;
    }
    ...
    public decimal TotalCostToCompany
    {
        get; set;
    }

    // Breakdowns détaillés
    public CnssBreakdownDto? CnssBreakdown
    {
        get; set;
    }
    public CimrBreakdownDto? CimrBreakdown
    {
        get; set;
    }
    public IrBreakdownDto? IrBreakdown
    {
        get; set;
    }
}
...
public class CnssBreakdownDto
{
    ...
    public decimal SalaireBrutPlafonne
    {
        get; set;
    }
...
public class CimrBreakdownDto
{
    ...
    public decimal SalaireReference
    {
        get; set;
    }
    ...
    public decimal CotisationSalariale
    {
        get; set;
    }
    public decimal CotisationPatronale
    {
        get; set;
    }
}
...
public class IrBreakdownDto
{
    ...
    public decimal TauxFraisPro
    {
        get; set;
    }
    public decimal PlafondFraisPro
    {
        get; set;
    }
    public decimal SalaireNetImposable
    {
        get; set;
    }
    ...
    public decimal DeductionChargesFamille
    {
        get; set;
    }
    public int NombrePersonnesACharge
    {
        get; set;
    }
    public decimal IrNet
    {
        get; set;
    }
}
