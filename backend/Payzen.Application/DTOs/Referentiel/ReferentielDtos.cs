...
{
    public string? Code { get; set; }
    [StringLength(200)] public string? NameFr { get; set; }
    [StringLength(200)] public string? NameAr { get; set; }
...
public class GenderCreateDto
{
    ...
    [StringLength(200)] public required string NameFr { get; set; }
    [StringLength(200)] public string? NameAr { get; set; }
    [StringLength(200)] public string? NameEn { get; set; }
}
...
public class RuleCapDto { public int Id { get; set; } public decimal CapAmount { get; set; } public CapUnit CapUnit { get; set; } }
public class CreateRuleCapDto { public decimal CapAmount { get; set; } public CapUnit CapUnit { get; set; } public decimal? MinAmount { get; set; } }

public class RulePercentageDto { public int Id { get; set; } public decimal Percentage { get; set; } public BaseReference BaseReference { get; set; } public int? EligibilityId { get; set; } public string? EligibilityName { get; set; } }
public class CreateRulePercentageDto { public decimal Percentage { get; set; } public BaseReference BaseReference { get; set; } public int? EligibilityId { get; set; } }

public class RuleFormulaDto { public int Id { get; set; } public decimal Multiplier { get; set; } public int ParameterId { get; set; } public string ParameterName { get; set; } = string.Empty; public CapUnit ResultUnit { get; set; } public decimal CurrentCapValue { get; set; } }
public class CreateRuleFormulaDto { public decimal Multiplier { get; set; } public int ParameterId { get; set; } public CapUnit ResultUnit { get; set; } }
...
public class RuleTierDto { public int Id { get; set; } public int TierOrder { get; set; } public decimal? MinAmount { get; set; } public decimal? MaxAmount { get; set; } public decimal ExemptionRate { get; set; } }
public class CreateRuleTierDto { public int TierOrder { get; set; } public decimal? MinAmount { get; set; } public decimal? MaxAmount { get; set; } public decimal ExemptionRate { get; set; } }
...
public class AncienneteRateDto { public int Id { get; set; } public int MinYears { get; set; } public int? MaxYears { get; set; } public decimal Rate { get; set; } }
public class CreateAncienneteRateDto { public int MinYears { get; set; } public int? MaxYears { get; set; } public decimal Rate { get; set; } }
