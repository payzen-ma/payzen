...
public class DashboardHrVueGlobaleKpisDto
{
    ...
    public decimal MasseSalarialeMad
    {
        get; set;
    }
    public decimal Turnover12mPct
    {
        get; set;
    }
...
{
    public decimal FemalePct
    {
        get; set;
    }
    public decimal MalePct
    {
        get; set;
    }
}
...
public class DashboardHrMovementRowDto
{
    ...
    public DashboardHrMovementType MovementType
    {
        get; set;
    }
}
...
{
    public decimal BrutTotalMad
    {
        get; set;
    }
    public decimal NetTotalMad
    {
        get; set;
    }
    public decimal ChargesPatronalesMad
    {
        get; set;
    }
    public decimal CoutTotalEmployeurMad
    {
        get; set;
    }
}
...
public class DashboardHrDepartmentPayrollDto
{
    ...
    public decimal AmountMad
    {
        get; set;
    }
    public decimal SharePct
    {
        get; set;
    }
}
...
{
    public int EffectifFemmes
    {
        get; set;
    }
    public int EffectifHommes
    {
        get; set;
    }
    public decimal EcartSalarialPct
    {
        get; set;
    }
}
...
{
    public decimal CnssSalarialeMad
    {
        get; set;
    }
    public decimal CnssPatronaleMad
    {
        get; set;
    }
    public decimal AmoSalarialeMad
    {
        get; set;
    }
    public decimal IrRetenuSourceMad
    {
        get; set;
    }
}
...
{
    public DashboardHrDeclarationType Type
    {
        get; set;
    }
    ...
    public DashboardHrDeclarationStatus Status
    {
        get; set;
    }
...
public class DashboardSummaryDto
{
    ...
    public int AccountingFirmsCount
    {
        get; set;
    }
    public double AvgEmployeesPerCompany
    {
        get; set;
    }
...
public class EmployeeDashboardDataDto
{
    ...
    public decimal SalaryNet
    {
        get; set;
    }
    public string PaidDate { get; set; } = string.Empty;

    public decimal LeavesRemaining
    {
        get; set;
    }
    public decimal LeavesTotal
    {
        get; set;
    }

    public int PresenceDays
    {
        get; set;
    }
...
public class CeoChartPointDto
{
    ...
    public decimal NetMad
    {
        get; set;
    }
    public decimal ChargesMad
    {
        get; set;
    }
}
