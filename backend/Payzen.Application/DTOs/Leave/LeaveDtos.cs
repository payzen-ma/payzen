...
public class LeaveTypePolicyPatchDto
{
    ...
    public LeaveAccrualMethod? AccrualMethod
    {
        get; set;
    }
    public decimal? DaysPerMonthAdult
    {
        get; set;
    }
    public decimal? DaysPerMonthMinor
    {
        get; set;
    }
    public decimal? BonusDaysPerYearAfter5Years
    {
        get; set;
    }
    public bool? RequiresEligibility6Months
    {
        get; set;
    }
    public bool? RequiresBalance
    ...
    public bool? UseWorkingCalendar
    {
        get; set;
    }
}
...
public class LeaveTypeLegalRuleCreateDto
{
    ...
    [Range(1, 3650)]
    public int? MustBeUsedWithinDays
    {
        get; set;
    }
}
...
public class LeaveRequestReadDto
{
    ...
    public string? LegalCaseCode
    {
        get; set;
    }
    public string? LegalCaseDescription
    {
        get; set;
    }
    public int? LegalDaysGranted
    {
        get; set;
    }
    public string? LegalArticle
    ...
    public decimal WorkingDaysDeducted
    {
        get; set;
    }
    public bool HasMinConsecutiveBlock
    {
        get; set;
    }
...
public class LeaveRequestApprovalHistoryCreateDto
{
    ...
    [Required]
    public LeaveApprovalAction Action
    {
        get; set;
    }

    public DateTimeOffset? ActionAt
    {
        get; set;
    }
    public int? ActionBy
...
public class LeaveRequestExemptionCreateDto
{
    ...
    [Required]
    public DateOnly ExemptionDate
    {
        get; set;
    }

    [Required]
    public LeaveExemptionReasonType ReasonType
    {
        get; set;
    }
...
public class LeaveBalancePatchDto
{
    ...
    public decimal? CarryInDays
    {
        get; set;
    }
    public decimal? CarryOutDays
    {
        get; set;
    }
    public decimal? ClosingDays
    {
        get; set;
    }
    public DateOnly? CarryoverExpiresOn
...
public class LeaveBalanceReadDto
{
    ...
    public DateOnly? BalanceExpiresOn
    {
        get; set;
    }
    public decimal OpeningDays
    ...
    public bool IsCarryoverExpired
    {
        get; set;
    }
    public DateTimeOffset? LastRecalculatedAt
