...
public class CompanyCreateDto
{
    ...
    [StringLength(500)]
    public required string CompanyEmail
    {
        get; set;
    }
    ...
    [StringLength(20)]
    public required string CompanyPhoneNumber
    {
        get; set;
    }
    ...
    [StringLength(1000)]
    public required string CompanyAddress
    {
        get; set;
    }
    ...
    public required string AdminFirstName
    {
        get; set;
    }
    ...
    [StringLength(100, MinimumLength = 2)]
    public required string AdminLastName
    {
        get; set;
    }
    ...
    [EmailAddress(ErrorMessage = "Format d'email invalide")]
    [StringLength(500)]
    public required string AdminEmail
    {
        get; set;
    }
...
public class CompanyCreateByExpertDto : CompanyCreateDto
{
    ...
    public required int ManagedByCompanyId
    {
        get; set;
    }
}
...
public class CompanyHistoryDto
{
    ...
    public ModifiedByDto? ModifiedBy
    {
        get; set;
    }
...
public class ContractTypeCreateDto
{
    ...
    public required string ContractTypeName
    {
        get; set;
    }
    ...
    public int? LegalContractTypeId
    {
        get; set;
    }
    public int? StateEmploymentProgramId
    {
        get; set;
    }
}
...
public class ContractTypeReadDto
{
    ...
    public string? LegalContractTypeName
    {
        get; set;
    }
    public int? StateEmploymentProgramId
    ...
    public string? StateEmploymentProgramName
    {
        get; set;
    }
    public DateTime CreatedAt
...
public class HolidayCreateDto
{
    ...
    public required DateOnly HolidayDate
    {
        get; set;
    }
    ...
    public required string HolidayType
    {
        get; set;
    }  // National, Religieux, Company, etc.
...
public class HolidayUpdateDto
{
    ...
    public bool? AffectPayroll
    {
        get; set;
    }
    public bool? AffectAttendance
    {
        get; set;
    }
    public bool? IsActive
...
public class WorkingCalendarCreateDto
{
    ...
    public required bool IsWorkingDay
    {
        get; set;
    }
...
public class PublicCompanySignupDto
{
    ...
    public required string AdminPhone
    {
        get; set;
    }
}
