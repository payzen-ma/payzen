...
public class DepartementCreateDto
{
    ...
    [StringLength(
        500,
        MinimumLength = 2,
        ErrorMessage = "Le nom du département doit contenir entre 2 et 500 caractères"
    )]
...
public class ContractTypeCreateDto
{
    ...
    [StringLength(
        100,
        MinimumLength = 2,
        ErrorMessage = "Le nom du type de contrat doit contenir entre 2 et 100 caractères"
    )]
