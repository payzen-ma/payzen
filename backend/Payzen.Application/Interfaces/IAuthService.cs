...
public interface IAuthService
{
    ...
    Task<ServiceResult<UserReadDto>> UpdateUserAsync(int id, UserUpdateDto dto, int updatedBy, CancellationToken ct = default);
    ...
    Task<ServiceResult<PermissionReadDto>> CreatePermissionAsync(PermissionCreateDto dto, int createdBy, CancellationToken ct = default);
    Task<ServiceResult<PermissionReadDto>> UpdatePermissionAsync(int id, PermissionUpdateDto dto, int updatedBy, CancellationToken ct = default);
    Task<ServiceResult> DeletePermissionAsync(int id, int deletedBy, CancellationToken ct = default);

    // ── Role ↔ Permission ────────────────────────────────────
    Task<ServiceResult<IEnumerable<RolePermissionSimpleDto>>> GetPermissionsForRoleAsync(int roleId, CancellationToken ct = default);
    Task<ServiceResult<RolePermissionReadDto>> AssignPermissionToRoleAsync(RolePermissionAssignDto dto, int createdBy, CancellationToken ct = default);
    Task<ServiceResult> BulkAssignPermissionsToRoleAsync(RolePermissionsBulkAssignDto dto, int createdBy, CancellationToken ct = default);
    ...
    Task<ServiceResult<IEnumerable<UserRoleSimpleDto>>> GetRolesForUserAsync(int userId, CancellationToken ct = default);
    Task<ServiceResult<UserRoleReadDto>> AssignRoleToUserAsync(UserRoleAssignDto dto, int createdBy, CancellationToken ct = default);
    Task<ServiceResult> BulkAssignRolesToUserAsync(UserRolesBulkAssignDto dto, int createdBy, CancellationToken ct = default);
    ...
    Task<ServiceResult<IEnumerable<UserRoleSimpleDto>>> GetRolesForEmployeeAsync(int employeeId, CancellationToken ct = default);
