...
public interface ILeaveTypeService
{
    ...
    Task<ServiceResult<LeaveTypeReadDto>> CreateAsync(
        LeaveTypeCreateDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<LeaveTypeReadDto>> PatchAsync(
        int id,
...
{
    Task<ServiceResult<IEnumerable<LeaveBalanceReadDto>>> GetByEmployeeAsync(
        int employeeId,
        int? leaveTypeId,
        CancellationToken ct = default
    );
    Task<ServiceResult<LeaveBalanceReadDto>> CreateAsync(
        LeaveBalanceCreateDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<LeaveBalanceReadDto>> PatchAsync(
        int id,
...
{
    Task<ServiceResult<IEnumerable<LeaveAuditLogReadDto>>> GetAsync(
        int? companyId,
        int? leaveRequestId,
        CancellationToken ct = default
    );
...
public interface IPayComponentService
{
    ...
    Task<ServiceResult<IEnumerable<PayComponentReadDto>>> GetEffectiveAsync(
        DateTime? asOf,
        CancellationToken ct = default
    );
    ...
    Task<ServiceResult<PayComponentReadDto>> CreateAsync(
        PayComponentWriteDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<PayComponentReadDto>> UpdateAsync(
        int id,
        PayComponentWriteDto dto,
        int updatedBy,
        CancellationToken ct = default
...
{
    // Éléments
    Task<ServiceResult<IEnumerable<ReferentielElementListDto>>> GetElementsAsync(
        bool? isActive,
        CancellationToken ct = default
    );
    Task<ServiceResult<ReferentielElementDto>> GetElementByIdAsync(int id, CancellationToken ct = default);
    Task<ServiceResult<ReferentielElementDto>> CreateElementAsync(
        CreateReferentielElementDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<ReferentielElementDto>> UpdateElementAsync(
        int id,
    ...
    // Règles
    Task<ServiceResult<ElementRuleDto>> CreateRuleAsync(
        CreateElementRuleDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<ElementRuleDto>> UpdateRuleAsync(
        int id,
    ...
    Task<ServiceResult<LegalParameterDto>> CreateLegalParameterAsync(
    ...
    Task<ServiceResult<AncienneteRateSetDto>> CreateRateSetAsync(
        CreateAncienneteRateSetDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<AncienneteRateSetDto>> CustomizeCompanyRatesAsync(
...
public interface IReferentielService
{
    ...
    Task<ServiceResult<CountryReadDto>> CreateCountryAsync(
        CountryCreateDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<CountryReadDto>> UpdateCountryAsync(
        int id,
    ...
    Task<ServiceResult<CityReadDto>> UpdateCityAsync(
        int id,
        CityUpdateDto dto,
        int updatedBy,
        CancellationToken ct = default
    ...
    Task<ServiceResult<NationalityReadDto>> CreateNationalityAsync(
    ...
    Task<ServiceResult<MaritalStatusReadDto>> CreateMaritalStatusAsync(
        MaritalStatusCreateDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<MaritalStatusReadDto>> UpdateMaritalStatusAsync(
        int id,
    ...
    Task<ServiceResult<GenderReadDto>> CreateGenderAsync(
        GenderCreateDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<GenderReadDto>> UpdateGenderAsync(
        int id,
        GenderUpdateDto dto,
        int updatedBy,
        CancellationToken ct = default
    ...
    Task<ServiceResult<StatusReadDto>> CreateStatusAsync(
        StatusCreateDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<StatusReadDto>> UpdateStatusAsync(
        int id,
        StatusUpdateDto dto,
        int updatedBy,
        CancellationToken ct = default
    ...
    Task<ServiceResult<EducationLevelReadDto>> CreateEducationLevelAsync(
        EducationLevelCreateDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<EducationLevelReadDto>> UpdateEducationLevelAsync(
        int id,
    ...
    Task<ServiceResult<IEnumerable<LegalContractTypeReadDtos>>> GetLegalContractTypesAsync(
        CancellationToken ct = default
    );
    Task<ServiceResult<LegalContractTypeReadDtos>> GetLegalContractTypeByIdAsync(
        int id,
        CancellationToken ct = default
    );
    Task<ServiceResult<LegalContractTypeReadDtos>> CreateLegalContractTypeAsync(
        LegalContractTypeCreateDtos dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<LegalContractTypeReadDtos>> UpdateLegalContractTypeAsync(
        int id,
    ...
    Task<ServiceResult<IEnumerable<StateEmploymentProgramReadDto>>> GetStateEmploymentProgramsAsync(
        CancellationToken ct = default
    );
    Task<ServiceResult<StateEmploymentProgramReadDto>> GetStateEmploymentProgramByIdAsync(
        int id,
        CancellationToken ct = default
    );
    Task<ServiceResult<StateEmploymentProgramReadDto>> CreateStateEmploymentProgramAsync(
        StateEmploymentProgramCreateDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<StateEmploymentProgramReadDto>> UpdateStateEmploymentProgramAsync(
        int id,
    ...
    // OvertimeRateRule
    Task<ServiceResult<IEnumerable<OvertimeRateRuleReadDto>>> GetOvertimeRateRulesAsync(
        bool? isActive,
        CancellationToken ct = default
    );
    ...
    Task<ServiceResult<OvertimeRateRuleReadDto>> CreateOvertimeRateRuleAsync(
        OvertimeRateRuleCreateDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<OvertimeRateRuleReadDto>> UpdateOvertimeRateRuleAsync(
        int id,
