...
public interface IEmployeeService
{
    ...
    Task<ServiceResult<IEnumerable<EmployeeReadDto>>> GetByDepartementAsync(
        int departementId,
        CancellationToken ct = default
    );
    Task<ServiceResult<IEnumerable<EmployeeReadDto>>> GetSubordinatesAsync(
        int managerId,
        CancellationToken ct = default
    );
    Task<ServiceResult<EmployeeFormDataDto>> GetFormDataAsync(
        int? companyId,
        int requestingUserId,
        CancellationToken ct = default
    );
    Task<ServiceResult<EmployeeReadDto>> CreateAsync(
        EmployeeCreateDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<EmployeeReadDto>> UpdateAsync(
        int id,
    ...
    Task<ServiceResult<SageImportResultDto>> ImportFromSageAsync(
        Stream csvStream,
        int? companyId,
        int userId,
        int? month,
    ...
    // ── Contract ─────────────────────────────────────────────
    Task<ServiceResult<IEnumerable<EmployeeContractReadDto>>> GetContractsAsync(
        int employeeId,
        CancellationToken ct = default
    );
    Task<ServiceResult<EmployeeContractReadDto>> CreateContractAsync(
        EmployeeContractCreateDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<EmployeeContractReadDto>> UpdateContractAsync(
        int id,
    ...
    // ── Salary ───────────────────────────────────────────────
    Task<ServiceResult<IEnumerable<EmployeeSalaryReadDto>>> GetSalariesAsync(
        int employeeId,
        CancellationToken ct = default
    );
    Task<ServiceResult<EmployeeSalaryReadDto>> CreateSalaryAsync(
        EmployeeSalaryCreateDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<EmployeeSalaryReadDto>> UpdateSalaryAsync(
        int id,
    ...
    // ── SalaryComponent ──────────────────────────────────────
    Task<ServiceResult<IEnumerable<EmployeeSalaryComponentReadDto>>> GetSalaryComponentsAsync(
        int salaryId,
        CancellationToken ct = default
    );
    Task<ServiceResult<EmployeeSalaryComponentReadDto>> CreateSalaryComponentAsync(
        EmployeeSalaryComponentCreateDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<EmployeeSalaryComponentReadDto>> UpdateSalaryComponentAsync(
        int id,
    ...
    // ── Address ──────────────────────────────────────────────
    Task<ServiceResult<IEnumerable<EmployeeAddressReadDto>>> GetAddressesAsync(
        int employeeId,
        CancellationToken ct = default
    );
    Task<ServiceResult<EmployeeAddressReadDto>> CreateAddressAsync(
        EmployeeAddressCreateDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<EmployeeAddressReadDto>> UpdateAddressAsync(
        int id,
    ...
    // ── Document ─────────────────────────────────────────────
    Task<ServiceResult<IEnumerable<EmployeeDocumentReadDto>>> GetDocumentsAsync(
        int employeeId,
        CancellationToken ct = default
    );
    Task<ServiceResult<EmployeeDocumentReadDto>> CreateDocumentAsync(
        EmployeeDocumentCreateDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<EmployeeDocumentReadDto>> UpdateDocumentAsync(
        int id,
    ...
    // ── Absence ──────────────────────────────────────────────
    Task<ServiceResult<IEnumerable<EmployeeAbsenceReadDto>>> GetAbsencesAsync(
        int employeeId,
        CancellationToken ct = default
    );
    Task<ServiceResult<EmployeeAbsenceStatsDto>> GetAbsenceStatsAsync(
        int companyId,
        int? employeeId,
        CancellationToken ct = default
    );
    Task<ServiceResult<EmployeeAbsenceReadDto>> CreateAbsenceAsync(
        EmployeeAbsenceCreateDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<EmployeeAbsenceReadDto>> UpdateAbsenceAsync(
        int id,
        EmployeeAbsenceUpdateDto dto,
        int updatedBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<EmployeeAbsenceReadDto>> DecideAbsenceAsync(
        int id,
        EmployeeAbsenceDecisionDto dto,
        int decidedBy,
        CancellationToken ct = default
    );
    Task<ServiceResult> CancelAbsenceAsync(
        int id,
    ...
    // ── Overtime ─────────────────────────────────────────────
    Task<ServiceResult<IEnumerable<EmployeeOvertimeListDto>>> GetOvertimesAsync(
        int employeeId,
        CancellationToken ct = default
    );
    Task<ServiceResult<EmployeeOvertimeReadDto>> GetOvertimeByIdAsync(int id, CancellationToken ct = default);
    Task<ServiceResult<EmployeeOvertimeCreateOutcomeDto>> CreateOvertimeAsync(
        EmployeeOvertimeCreateDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<EmployeeOvertimeReadDto>> UpdateOvertimeAsync(
        int id,
        EmployeeOvertimeUpdateDto dto,
        int updatedBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<EmployeeOvertimeReadDto>> SubmitOvertimeAsync(
        int id,
        EmployeeOvertimeSubmitDto dto,
        int userId,
        CancellationToken ct = default
    );
    Task<ServiceResult<EmployeeOvertimeReadDto>> DecideOvertimeAsync(
        int id,
    ...
    // ── Attendance ───────────────────────────────────────────
    Task<ServiceResult<IEnumerable<EmployeeAttendanceReadDto>>> GetAttendancesAsync(
        int employeeId,
        DateOnly? from,
        DateOnly? to,
        CancellationToken ct = default
    );
    Task<ServiceResult<EmployeeAttendanceReadDto>> CreateAttendanceAsync(
    ...
    // ── Category ─────────────────────────────────────────────
    Task<ServiceResult<IEnumerable<EmployeeCategoryReadDto>>> GetCategoriesAsync(
        int companyId,
        CancellationToken ct = default
    );
    Task<ServiceResult<IEnumerable<EmployeeCategoryReadDto>>> GetCategoriesByModeAsync(
    ...
    Task<ServiceResult<EmployeeCategoryReadDto>> CreateCategoryAsync(
        EmployeeCategoryCreateDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<EmployeeCategoryReadDto>> UpdateCategoryAsync(
        int id,
