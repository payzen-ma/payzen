...
public interface ICompanyService
{
    ...
    Task<ServiceResult<IEnumerable<CompanyListDto>>> GetManagedByAsync(
        int expertCompanyId,
    ...
    Task<ServiceResult<CompanyCreateResponseDto>> CreateByExpertAsync(
        CompanyCreateByExpertDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<CompanyReadDto>> PatchAsync(
        int id,
    ...
    Task<ServiceResult<IEnumerable<DepartementReadDto>>> GetDepartementsAsync(
        int companyId,
        CancellationToken ct = default
    );
    Task<ServiceResult<DepartementReadDto>> CreateDepartementAsync(
        DepartementCreateDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<DepartementReadDto>> UpdateDepartementAsync(
        int id,
    ...
    Task<ServiceResult<IEnumerable<JobPositionReadDto>>> GetJobPositionsAsync(
        int companyId,
        CancellationToken ct = default
    );
    Task<ServiceResult<JobPositionReadDto>> CreateJobPositionAsync(
        JobPositionCreateDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<JobPositionReadDto>> UpdateJobPositionAsync(
        int id,
    ...
    // ── ContractType ─────────────────────────────────────────
    Task<ServiceResult<IEnumerable<ContractTypeReadDto>>> GetContractTypesAsync(
        int companyId,
        CancellationToken ct = default
    );
    Task<ServiceResult<ContractTypeReadDto>> GetContractTypeByIdAsync(int id, CancellationToken ct = default);
    Task<ServiceResult<ContractTypeReadDto>> CreateContractTypeAsync(
        ContractTypeCreateDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<ContractTypeReadDto>> UpdateContractTypeAsync(
        int id,
    ...
    // ── WorkingCalendar ──────────────────────────────────────
    Task<ServiceResult<IEnumerable<WorkingCalendarReadDto>>> GetAllWorkingCalendarsAsync(
        CancellationToken ct = default
    );
    Task<ServiceResult<IEnumerable<WorkingCalendarReadDto>>> GetWorkingCalendarAsync(
        int companyId,
        CancellationToken ct = default
    );
    Task<ServiceResult<WorkingCalendarReadDto>> GetWorkingCalendarDayByIdAsync(int id, CancellationToken ct = default);
    Task<ServiceResult<WorkingCalendarReadDto>> UpsertWorkingCalendarDayAsync(
        WorkingCalendarCreateDto dto,
        int userId,
        CancellationToken ct = default
    );
    Task<ServiceResult<WorkingCalendarReadDto>> UpdateWorkingCalendarDayAsync(
        int id,
    ...
    // ── Holiday ──────────────────────────────────────────────
    Task<ServiceResult<IEnumerable<HolidayReadDto>>> GetHolidaysAsync(
        int? companyId,
        int? year,
        CancellationToken ct = default
    );
    Task<ServiceResult<HolidayReadDto>> GetHolidayByIdAsync(int id, CancellationToken ct = default);
    Task<ServiceResult<HolidayReadDto>> CreateHolidayAsync(
        HolidayCreateDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<HolidayReadDto>> UpdateHolidayAsync(
        int id,
    ...
    Task<ServiceResult<IEnumerable<CompanyDocumentReadDto>>> GetDocumentsAsync(
        int companyId,
        CancellationToken ct = default
    );
    Task<ServiceResult<CompanyDocumentReadDto>> CreateDocumentAsync(
        CompanyDocumentCreateDto dto,
        int createdBy,
        CancellationToken ct = default
    );
    Task<ServiceResult<CompanyDocumentReadDto>> UpdateDocumentAsync(
        int id,
...
{
    Task<ServiceResult<string>> SaveFileAsync(
        IFormFile file,
        int companyId,
        string? documentType,
        CancellationToken ct = default
    ...
    Task<ServiceResult<(byte[] fileBytes, string contentType, string fileName)>> GetFileAsync(
        string filePath,
        CancellationToken ct = default
    );
}
