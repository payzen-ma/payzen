...
public interface IDocumentService
{
    ...
    Task<ServiceResult<byte[]>> GeneratePayslipByEmployeePeriodAsync(
        int employeeId,
        int year,
        int month,
        int? half,
    ...
    Task<ServiceResult<byte[]>> GenerateEtatCnssPdfAsync(
        int companyId,
        int year,
        int month,
        CancellationToken ct = default
    );
    Task<ServiceResult<byte[]>> GenerateEtatIrPdfAsync(
        int companyId,
        int year,
        int month,
        CancellationToken ct = default
    );
    Task<ServiceResult<byte[]>> GenerateJournalPaieCsvAsync(
        int companyId,
        int year,
        int month,
        CancellationToken ct = default
