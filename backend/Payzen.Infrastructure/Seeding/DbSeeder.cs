...
public static class DbSeeder
{
    ...
    private static async Task SeedRolesAndPermissionsAsync(AppDbContext db, CancellationToken ct)
    {
        ...
        {
           // Users
            new Permissions { Name = "READ_USERS",                  Description = "Lister tous les utilisateurs",           Resource = "users",             Action = "read",        CreatedBy = 1 },
            new Permissions { Name = "VIEW_USERS",                  Description = "Voir un utilisateur par ID",             Resource = "users",             Action = "view",        CreatedBy = 1 },
            new Permissions { Name = "CREATE_USERS",                Description = "Créer un utilisateur",                  Resource = "users",             Action = "create",      CreatedBy = 1 },
            new Permissions { Name = "EDIT_USERS",                  Description = "Modifier un utilisateur",               Resource = "users",             Action = "edit",        CreatedBy = 1 },
            new Permissions { Name = "DELETE_USERS",                Description = "Supprimer un utilisateur",              Resource = "users",             Action = "delete",      CreatedBy = 1 },
            // Roles
            new Permissions { Name = "READ_ROLES",                  Description = "Lister tous les rôles",                 Resource = "roles",             Action = "read",        CreatedBy = 1 },
            new Permissions { Name = "VIEW_ROLES",                  Description = "Voir un rôle par ID",                   Resource = "roles",             Action = "view",        CreatedBy = 1 },
            new Permissions { Name = "CREATE_ROLES",                Description = "Créer un rôle",                        Resource = "roles",             Action = "create",      CreatedBy = 1 },
            new Permissions { Name = "EDIT_ROLES",                  Description = "Modifier un rôle",                     Resource = "roles",             Action = "edit",        CreatedBy = 1 },
            new Permissions { Name = "DELETE_ROLES",                Description = "Supprimer un rôle",                    Resource = "roles",             Action = "delete",      CreatedBy = 1 },
            new Permissions { Name = "VIEW_ROLES_USERS",            Description = "Voir les utilisateurs d'un rôle",      Resource = "roles",             Action = "view",        CreatedBy = 1 },
            // Permissions
            new Permissions { Name = "READ_PERMISSIONS",            Description = "Lister toutes les permissions",         Resource = "permissions",       Action = "read",        CreatedBy = 1 },
            new Permissions { Name = "CREATE_PERMISSIONS",          Description = "Créer une permission",                 Resource = "permissions",       Action = "create",      CreatedBy = 1 },
            new Permissions { Name = "EDIT_PERMISSIONS",            Description = "Modifier une permission",              Resource = "permissions",       Action = "edit",        CreatedBy = 1 },
            new Permissions { Name = "DELETE_PERMISSIONS",          Description = "Supprimer une permission",             Resource = "permissions",       Action = "delete",      CreatedBy = 1 },
            // Roles <-> Permissions
            new Permissions { Name = "READ_ROLES_PERMISSIONS",      Description = "Voir les permissions d'un rôle",       Resource = "roles-permissions", Action = "read",        CreatedBy = 1 },
            new Permissions { Name = "ASSIGN_ROLES_PERMISSIONS",    Description = "Assigner une permission à un rôle",    Resource = "roles-permissions", Action = "assign",      CreatedBy = 1 },
            new Permissions { Name = "BULK_ASSIGN_ROLES_PERMISSION",Description = "Assigner en masse des permissions",    Resource = "roles-permissions", Action = "bulk-assign", CreatedBy = 1 },
            new Permissions { Name = "DELETE_ROLES_PERMISSIONS",    Description = "Révoquer une permission d'un rôle",    Resource = "roles-permissions", Action = "delete",      CreatedBy = 1 },
            // Users <-> Roles
            new Permissions { Name = "READ_USER_ROLES",             Description = "Voir les rôles d'un employé",          Resource = "users-roles",       Action = "read",        CreatedBy = 1 },
            new Permissions { Name = "ASSIGN_USERS_ROLES",          Description = "Assigner des rôles à un utilisateur",  Resource = "users-roles",       Action = "assign",      CreatedBy = 1 },
            new Permissions { Name = "BULK_ASSIGN_USERS_ROLES",     Description = "Assigner en masse des rôles",          Resource = "users-roles",       Action = "bulk-assign", CreatedBy = 1 },
            new Permissions { Name = "UPDATE_USERS_ROLES",          Description = "Remplacer les rôles d'un utilisateur", Resource = "users-roles",       Action = "update",      CreatedBy = 1 },
            new Permissions { Name = "DELETE_USER_ROLES",           Description = "Révoquer un rôle d'un utilisateur",    Resource = "users-roles",       Action = "delete",      CreatedBy = 1 },
           };
