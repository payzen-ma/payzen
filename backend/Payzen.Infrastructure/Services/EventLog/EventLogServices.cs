...
public class EmployeeEventLogService : IEmployeeEventLogService
{
    ...
    {
        _db.EmployeeEventLogs.Add(
            new EmployeeEventLog
            {
...
public class LeaveEventLogService : ILeaveEventLogService
{
    ...
    public async Task LogLeaveRequestEventAsync(
        ...
        int createdBy,
        CancellationToken ct = default
    ) => await LogEventAsync(companyId, employeeId, leaveRequestId, eventName, oldValue, newValue, createdBy, ct);
}
