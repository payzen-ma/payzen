...
public class PayrollResultConfiguration : IEntityTypeConfiguration<PayrollResult>
{
    public void Configure(EntityTypeBuilder<PayrollResult> entity)
    {
        ...
        {
            nameof(PayrollResult.SalaireBase),
            nameof(PayrollResult.HeuresSupp25),
            nameof(PayrollResult.HeuresSupp50),
            nameof(PayrollResult.HeuresSupp100),
            nameof(PayrollResult.Conges),
            nameof(PayrollResult.JoursFeries),
            nameof(PayrollResult.PrimeAnciennete),
            nameof(PayrollResult.PrimeAnciennteRate),
            nameof(PayrollResult.PrimeImposable1),
            nameof(PayrollResult.PrimeImposable2),
            nameof(PayrollResult.PrimeImposable3),
            nameof(PayrollResult.TotalPrimesImposables),
            nameof(PayrollResult.TotalBrut),
            nameof(PayrollResult.FraisProfessionnels),
            nameof(PayrollResult.IndemniteRepresentation),
            nameof(PayrollResult.PrimeTransport),
            nameof(PayrollResult.PrimePanier),
            nameof(PayrollResult.IndemniteDeplacement),
            nameof(PayrollResult.IndemniteCaisse),
            nameof(PayrollResult.PrimeSalissure),
            nameof(PayrollResult.GratificationsFamilial),
            nameof(PayrollResult.PrimeVoyageMecque),
            nameof(PayrollResult.IndemniteLicenciement),
            nameof(PayrollResult.IndemniteKilometrique),
            nameof(PayrollResult.PrimeTourne),
            nameof(PayrollResult.PrimeOutillage),
            nameof(PayrollResult.AideMedicale),
            nameof(PayrollResult.AutresPrimesNonImposable),
            nameof(PayrollResult.TotalIndemnites),
            nameof(PayrollResult.TotalNiExcedentImposable),
            nameof(PayrollResult.CnssPartSalariale),
            nameof(PayrollResult.CnssBase),
            nameof(PayrollResult.CimrPartSalariale),
            nameof(PayrollResult.CimrBase),
            nameof(PayrollResult.AmoPartSalariale),
            nameof(PayrollResult.AmoBase),
            nameof(PayrollResult.MutuellePartSalariale),
            nameof(PayrollResult.MutuelleBase),
            nameof(PayrollResult.TotalCotisationsSalariales),
            nameof(PayrollResult.CnssPartPatronale),
            nameof(PayrollResult.CimrPartPatronale),
            nameof(PayrollResult.AmoPartPatronale),
            nameof(PayrollResult.MutuellePartPatronale),
            nameof(PayrollResult.TotalCotisationsPatronales),
            nameof(PayrollResult.ImpotRevenu),
            nameof(PayrollResult.IrTaux),
            nameof(PayrollResult.Arrondi),
            nameof(PayrollResult.AvanceSurSalaire),
            nameof(PayrollResult.InteretSurLogement),
            nameof(PayrollResult.BrutImposable),
            nameof(PayrollResult.NetImposable),
            nameof(PayrollResult.TotalGains),
            nameof(PayrollResult.TotalRetenues),
            nameof(PayrollResult.NetAPayer),
            nameof(PayrollResult.TotalNet),
            nameof(PayrollResult.TotalNet2),
        };
...
public class PayrollResultPrimeConfiguration : IEntityTypeConfiguration<PayrollResultPrime>
{
    public void Configure(EntityTypeBuilder<PayrollResultPrime> entity)
    {
        ...
        entity
            .HasOne(p => p.PayrollResult)
            .WithMany(pr => pr.Primes)
            .HasForeignKey(p => p.PayrollResultId)
            .OnDelete(DeleteBehavior.Restrict);
    }
}
...
public class PayrollCalculationAuditStepConfiguration : IEntityTypeConfiguration<PayrollCalculationAuditStep>
{
    public void Configure(EntityTypeBuilder<PayrollCalculationAuditStep> entity)
    {
        ...
        entity
            .HasOne(s => s.PayrollResult)
            .WithMany(pr => pr.CalculationAuditSteps)
...
public class SalaryPackageConfiguration : IEntityTypeConfiguration<SalaryPackage>
{
    public void Configure(EntityTypeBuilder<SalaryPackage> entity)
    {
        ...
        entity
            .HasOne(sp => sp.BusinessSector)
            .WithMany(bs => bs.SalaryPackages)
            .HasForeignKey(sp => sp.BusinessSectorId)
            .OnDelete(DeleteBehavior.Restrict);
    }
}
...
public class SalaryPackageItemConfiguration : IEntityTypeConfiguration<SalaryPackageItem>
{
    public void Configure(EntityTypeBuilder<SalaryPackageItem> entity)
    {
        ...
        entity
            .HasOne(i => i.SalaryPackage)
            .WithMany(sp => sp.Items)
            .HasForeignKey(i => i.SalaryPackageId)
            .OnDelete(DeleteBehavior.Restrict);
        entity
            .HasOne(i => i.PayComponent)
            .WithMany(pc => pc.PackageItems)
            .HasForeignKey(i => i.PayComponentId)
            .OnDelete(DeleteBehavior.SetNull);
        entity
            .HasOne(i => i.ReferentielElement)
            .WithMany()
            .HasForeignKey(i => i.ReferentielElementId)
            .OnDelete(DeleteBehavior.SetNull);
    }
}
...
public class SalaryPackageAssignmentConfiguration : IEntityTypeConfiguration<SalaryPackageAssignment>
{
    public void Configure(EntityTypeBuilder<SalaryPackageAssignment> entity)
    {
        ...
        entity
            .HasOne(a => a.SalaryPackage)
            .WithMany(sp => sp.Assignments)
            .HasForeignKey(a => a.SalaryPackageId)
            .OnDelete(DeleteBehavior.Restrict);
        ...
        entity
            .HasOne(a => a.EmployeeSalary)
            .WithMany()
            .HasForeignKey(a => a.EmployeeSalaryId)
            .OnDelete(DeleteBehavior.Restrict);
    }
}
