...
public class PublicSignupController : ControllerBase
{
    ...
    public PublicSignupController(IPublicSignupService signup)
    {
        _signup = signup;
    }
    ...
    [Authorize]
    public async Task<ActionResult> CompleteCompanyOnboarding(
        [FromBody] AuthenticatedCompanySignupDto dto,
