...
public class DashboardHrController : ControllerBase
{
    ...
    )
    {
        try
        {
            var result = await _dashboardHrService.GetHrDashboardRawAsync(
                ReadCompanyIdHeader(),
                month,
                cancellationToken
            );
        ...
        catch (Exception ex)
        {
            return StatusCode(
                ...
                new { Message = ex.Message, RequestedMonth = month }
            );
        }
    }
    ...
    )
    {
        try
        {
            var result = await _dashboardHrService.GetMouvementsRhAsync(
                ReadCompanyIdHeader(),
                month,
                cancellationToken
            );
    ...
    )
    {
        try
        {
            var result = await _dashboardHrService.GetMasseSalarialeAsync(
                ReadCompanyIdHeader(),
                month,
                cancellationToken
            );
    ...
    )
    {
        try
        {
            var result = await _dashboardHrService.GetPariteDiversiteAsync(
                ReadCompanyIdHeader(),
                month,
                cancellationToken
            );
    ...
    )
    {
        try
        {
            var result = await _dashboardHrService.GetConformiteSocialeAsync(
                ReadCompanyIdHeader(),
                month,
                cancellationToken
            );
