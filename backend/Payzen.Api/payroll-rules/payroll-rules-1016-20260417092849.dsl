MODULE[CUSTOM_PLAFOND_CNSS] {
  INPUTS  : salaire_brut_imposable
  OUTPUTS : base_cnss_rg

  RULE custom.plafond_cnss_7000 {
    ;; Surcharge du plafond CNSS standard (6000 MAD) par le plafond spécifique de 7000 MAD
    base_cnss_rg = MIN(salaire_brut_imposable, 7000.00)
  }
}
