...
public class Company : BaseEntity
{
    ...
    [StringLength(100)] public string? IceNumber { get; set; }
    [StringLength(100)] public string? IfNumber { get; set; }
    [StringLength(100)] public string? RcNumber { get; set; }
    public string? PatenteNumber { get; set; }
    [StringLength(100)] public string? RibNumber { get; set; }
    [StringLength(50)]  public string? LegalForm { get; set; }

    [StringLength(200)] public string? SignatoryName { get; set; }
    [StringLength(100)] public string? SignatoryTitle { get; set; }

    public DateTime? FoundingDate { get; set; }
    public string? WebsiteUrl { get; set; }

    [StringLength(10)]  public string Currency { get; set; } = "MAD";
    [StringLength(50)]  public string PayrollPeriodicity { get; set; } = "Mensuelle";

    [Range(1, 12)] public int FiscalYearStartMonth { get; set; } = 1;

    [StringLength(200)] public string? BusinessSector { get; set; }
    ...
    [StringLength(20)] public string? AuthType { get; set; } = "JWT";
