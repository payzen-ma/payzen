...
public class Employee : BaseEntity
{
    ...
    public DateOnly? AnnualLeaveOpeningEffectiveFrom
    {
        get; set;
    }
    ...
    public Company.Departement? Departement
    {
        get; set;
    }
    ...
    public ICollection<EmployeeSpouse>? Spouses
    {
        get; set;
    }
    public ICollection<EmployeeChild>? Children
    {
        get; set;
    }
}
