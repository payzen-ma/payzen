...
public class EmployeeOvertime : BaseEntity
{
    ...
    [Required] public OvertimeType OverTimeType { get; set; }
    [Required] public OvertimeEntryMode EntryMode { get; set; }

    public int? HolidayId { get; set; }
    public Company.Holiday? Holiday { get; set; }

    [Required] public DateOnly OvertimeDate { get; set; }

    public TimeOnly? StartTime { get; set; }
    public TimeOnly? EndTime { get; set; }
    public bool CrossesMidnight { get; set; }

    [Required][Range(0.01, 24.00)]
    ...
    [MaxLength(50)]  public string? RateRuleCodeApplied { get; set; }
    [MaxLength(200)] public string? RateRuleNameApplied { get; set; }

    [Required][Range(1.00, 10.00)]
    public decimal RateMultiplierApplied { get; set; } = 1.00m;

    [MaxLength(1000)] public string? MultiplierCalculationDetails { get; set; }
    ...
    [MaxLength(500)] public string? EmployeeComment { get; set; }
    ...
    public Referentiel.OvertimeRateRule? RateRule { get; set; }
